...
def resolve_dataset_path() -> Path:
    ...
    target = _DATA_DIR / "Heart_disease_statlog.csv"
    if dataset_url:
...
joblib.dump(DataModelBundle, _ARTIFACTS_DIR / "DataModel_hd.pkl")

#Capturing Formatted Data
X_test.to_csv(_DATA_DIR / "X_test_hd.csv", index=False)
y_test.to_csv(_DATA_DIR / "y_test_hd.csv", index=False)
X_train.to_csv(_DATA_DIR / "X_train_hd.csv", index=False)
y_train.to_csv(_DATA_DIR / "y_train_hd.csv", index=False)
